...
<table width="1200" border="0" cellspacing="0" cellpadding="0" bgcolor="#336699" align="center" >
<tr>
...
{
echo '<div style="float:right; vertical-align:top"  class="log-out"><a href="logout.php" style="font-size:20px;">Logout</a></div>';
}
?>
